...
# 👋 Meet the Mind Behind This Site
...
In 2024, I founded [**Connecto**](https://connecto.now)—a real-time social connection app built to solve a common but overlooked problem: people attending the same event often miss opportunities to meet others around them.
...
If you’re a fellow researcher, engineer, builder, or just someone curious—I’d love to connect. You can find me on [LinkedIn](#), check out my [GitHub](#), or explore [Connecto](https://connecto.now).
